...
$cuisineName = filter_input(INPUT_GET, 'name', FILTER_SANITIZE_FULL_SPECIAL_CHARS);

$recipes = new Recipes($connection);

if ($cuisineName) {
    $recipeList = $recipes->getRecipesByCuisine($cuisineName); // Assuming this method fetches recipes by cuisine

    //echo "<h3>Recipes in the '$cuisineName' Cuisine</h3>";
    if ($recipeList) {
        ...
        echo "<p>No recipes found in this cuisine.</p>";
    }
} else {
    echo "<p>No cuisine specified.</p>";
}
?>
<!DOCTYPE html>
<style>
...
<main>
    <section>
    <h3>Recipes in the <?php echo $cuisineName ?> Category</h3>
